...
|---------|-------------|----------------|
| **[Arena-b](https://github.com/M1tsumi/Arena-b)** | Super-fast arena allocator for Rust with basically zero overhead | Got tired of malloc being slow, so I built something faster |
